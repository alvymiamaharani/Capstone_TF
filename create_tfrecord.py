...
Usage:
  ...
  # Create train data:
  python generate_tfrecord.py --csv_input=datasets/train_labels.csv --image_dir=datasets/train --output_path=train.record

  # Create test data:
  python generate_tfrecord.py --csv_input=datasets/test_labels.csv  --image_dir=datasets/test --output_path=test.record
"""
